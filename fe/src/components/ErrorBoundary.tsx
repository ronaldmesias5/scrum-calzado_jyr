        ...
        <div className="flex min-h-screen items-center justify-center bg-gray-50 dark:bg-slate-950 p-4">
          <div className="max-w-md w-full bg-white dark:bg-slate-800 rounded-xl shadow-lg p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h2 className="text-xl font-bold text-gray-900 dark:text-white">Error en la aplicación</h2>
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Se ha producido un error inesperado</p>
              </div>
            </div>
