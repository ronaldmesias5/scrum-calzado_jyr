...
export function DashboardFooter({ className = '' }: DashboardFooterProps) {
  ...
  return (
    <footer
      className={`min-h-[112px] shrink-0 bg-white px-4 py-7 text-center text-slate-600 shadow-[0_-8px_24px_-24px_rgba(15,23,42,0.45)] transition-colors duration-500 dark:bg-slate-950 dark:text-gray-400 ${className}`}
    >
