    ...
    <section id="contacto" className="py-20 bg-white dark:bg-slate-950 transition-colors duration-500">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-16 gap-8">
          ...
          <button className="px-8 py-4 border-2 border-blue-800 dark:border-blue-500 text-blue-800 dark:text-blue-400 font-bold rounded-xl hover:bg-blue-50 dark:hover:bg-blue-900/30 transition-all duration-200 shadow-lg shadow-blue-800/5 btn-pulse" aria-label={t('landing.asesoria.cta')}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {benefits.map(({ icon: Icon, title, desc }) => (
            <div key={title} className="bg-gray-50 dark:bg-slate-900/50 rounded-2xl p-8 text-center border border-gray-100 dark:border-slate-800 hover:border-blue-200 dark:hover:border-blue-900 transition-all duration-300 group stagger-reveal">
