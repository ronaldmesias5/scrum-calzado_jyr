...
import { StatusBadge } from '../atoms/StatusBadgeComponent';
  ...
  return (
    <div className="bg-white dark:bg-slate-900/50 rounded-xl border border-gray-100 dark:border-slate-800 shadow-sm p-5 flex-1 transition-all duration-300">
      <div className="flex items-center justify-between mb-4">
        <h2 className="font-bold text-gray-900 dark:text-white transition-colors duration-500">
          Pedidos Recientes
        </h2>
        <button
          onClick={onViewAll}
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            <thead className="bg-gray-50 dark:bg-slate-800/80 border-b border-gray-200 dark:border-slate-800">
              <tr>
                <th className="text-left px-3 py-2 text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                  ID Pedido
                </th>
                <th className="text-left px-3 py-2 text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                  Cliente
