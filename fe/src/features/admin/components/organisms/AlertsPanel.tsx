      ...
      <div className="flex flex-col gap-2">
        {alerts.map((alert) => {
          ...
          return (
            <div
              key={alert.id}
              className="flex gap-3 items-start border-b border-gray-50 dark:border-slate-800 pb-3 last:border-0 last:pb-0 transition-colors"
            >
              <div
                className={`p-1.5 rounded-full ${bg} dark:bg-slate-800/80 mt-0.5 flex-shrink-0`}
              >
