...
export default function InventoryFormModal({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const message =
        err instanceof Error ? err.message : 'Error al guardar inventario';
  ...
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
      title={inventory ? 'Editar Inventario' : 'Agregar Inventario'}
      size="md"
    >
      <div className="flex flex-col">
        ...
        <form
          ...
          className="p-6 space-y-5 bg-white dark:bg-slate-900"
        >
          <div>
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              >
                <option value="" className="dark:bg-slate-800">
                  Selecciona o ingresa una talla
                </option>
