          ...
          {clientEmail ? (
            <div className="flex items-center gap-4 p-4 rounded-2xl bg-gray-50 dark:bg-slate-800/40 border border-gray-100 dark:border-slate-800 transition-all group">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-[10px] text-gray-500 dark:text-gray-500 font-black uppercase tracking-widest mb-0.5">
                  Electrónico
                </p>
                <p className="text-sm text-gray-900 dark:text-gray-100 font-bold truncate">
                  {clientEmail}
                </p>
              </div>
            ...
            <div className="flex items-center gap-4 p-4 rounded-2xl bg-gray-50 dark:bg-slate-800/20 border border-gray-100 dark:border-slate-800 opacity-60">
              ...
              <div>
                <p className="text-[10px] text-gray-500 dark:text-gray-500 font-black uppercase tracking-widest">
                  Email
                </p>
