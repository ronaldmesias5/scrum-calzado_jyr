      ...
      const fetchCurrentSupplies = async () => {
        try {
          ...
          res.supplies.forEach((s) => {
            ...
            links[s.supply_id] =
              qtyDozen % 1 === 0 ? qtyDozen.toString() : qtyDozen.toFixed(2);
          });
      ...
      if (formData.brand_name && brands.length > 0) {
        ...
        if (brand) {
          try {
            ...
            if (
              isOpen &&
              !stylesData.find((s) => s.name === formData.style_name)
            ) {
        ...
        <div className="p-6 space-y-6 overflow-y-auto flex-1 bg-white dark:bg-slate-900">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
              Edita el nombre tal como desees mostrar el producto
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              >
                <option value="">
                  {formData.brand_name ? 'Seleccionar estilo' : 'Elige marca'}
                </option>
                {styles.map((s) => (
              ...
              <div className="flex-1">
                ...
                >
                  <div className="text-center pointer-events-none">
                    <Upload
                      className={`mx-auto mb-1 ${isDragging ? 'text-blue-600' : 'text-gray-400 dark:text-gray-600'}`}
                      size={24}
                    />
