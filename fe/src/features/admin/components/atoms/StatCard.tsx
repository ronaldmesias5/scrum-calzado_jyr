    ...
    <div className="bg-white dark:bg-slate-900/50 rounded-xl border border-gray-200 dark:border-slate-800 p-6 shadow-sm hover:shadow-md transition-all duration-300">
      <div className="flex items-start justify-between mb-4">
        <div>
          ...
          <p
            className={`text-4xl font-bold ${c.number} transition-colors duration-500`}
          >
            {value}
          </p>
        </div>
        <div
          className={`${c.bg} p-3 rounded-xl border border-transparent dark:border-white/5 transition-all shadow-sm`}
        >
