...
import { BadgeCountsProvider } from '@/store/BadgeCountsContext';
    ...
    <CartProvider>
      <BadgeCountsProvider>
        <div className="flex flex-col min-h-screen bg-gray-50 dark:bg-slate-950 transition-colors duration-500">
          ...
          <div className="flex min-h-[calc(100vh-4rem)] items-stretch relative">
            <ClientSidebar
            ...
            <main id="main-content" className="flex min-w-0 flex-1 flex-col">
              <div className="flex-1 px-4 pb-8 pt-3 sm:px-8">
                <Breadcrumbs />
                <PageTransition>
                  <Outlet />
                </PageTransition>
              </div>
              <DashboardFooter className="shrink-0" />
            </main>
          </div>
        </div>
      </BadgeCountsProvider>
