...
export default function ClientsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Filtros */}
      <div className="bg-white dark:bg-slate-900/50 p-6 rounded-xl shadow-sm border border-gray-100 dark:border-slate-800 mb-6 grid grid-cols-1 md:grid-cols-3 gap-4 transition-all duration-300 stagger-reveal">
