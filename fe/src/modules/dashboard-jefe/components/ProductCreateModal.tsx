      ...
      <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-hidden shadow-2xl flex flex-col">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200 bg-white flex-shrink-0">
          <div>
            ...
            <p className="text-sm text-gray-600">Agrega un nuevo producto al catálogo</p>
          </div>
          <button
            onClick={onClose}
            ...
            <div>
              ...
              {styleMode === 'select' ? (
                <div className="flex gap-2">
                  <select
                    ...
                    className="flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none text-sm bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    <option value="">
                  ...
                  <button
                    ...
                    className="px-2 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors flex-shrink-0"
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    onChange={handleInputChange}
                    autoFocus
                    className="flex-1 px-3 py-2 border border-blue-400 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none text-sm bg-blue-50"
                    placeholder="Ej: Superstar, Air Max 90..."
                  />
                  <button
                    type="button"
                    onClick={() => { setStyleMode('select'); setFormData(prev => ({ ...prev, style_name: '' })); }}
                    className="px-2 py-2 border border-gray-300 text-gray-600 rounded-lg hover:bg-gray-100 transition-colors flex-shrink-0 text-xs"
              ...
              <p className="text-xs text-gray-500 mt-1">
                {styleMode === 'new'
                  ...
                  : styles.length > 0
                    ? `${styles.length} estilo${styles.length !== 1 ? 's' : ''} disponible${styles.length !== 1 ? 's' : ''} · Botón + para crear nuevo`
                    : formData.brand_name
