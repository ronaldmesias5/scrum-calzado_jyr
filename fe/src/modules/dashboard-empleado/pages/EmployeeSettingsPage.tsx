...
interface NotifSettings { taskAssigned: boolean; deadlineReminder: boolean; sharedReport: boolean; }
...
export default function EmployeeSettingsPage() {
  ...
  const [notif, setNotif] = useState<NotifSettings>(() =>
    loadPref('emp_cfg_notif', { taskAssigned: true, deadlineReminder: true, sharedReport: false })
  );
            ...
            <Card title="Preferencias de Notificación">
              <div className="space-y-6">
                <ToggleSetting
                  ...
                  onToggle={() => setNotif(p => ({ ...p, taskAssigned: !p.taskAssigned }))}
                />
                <ToggleSetting
                  icon={Clock}
                  ...
                  onToggle={() => setNotif(p => ({ ...p, deadlineReminder: !p.deadlineReminder }))}
                />
                <ToggleSetting
                  icon={BarChartIcon}
                  ...
                  onToggle={() => setNotif(p => ({ ...p, sharedReport: !p.sharedReport }))}
                />
              </div>
            </Card>
          )}
