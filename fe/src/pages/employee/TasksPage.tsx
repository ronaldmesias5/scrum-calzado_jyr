...
import EmployeeValeModal from '@/features/employee/components/molecules/EmployeeValeModal';
import { useToast } from '@/store/ToastContext';

/** Mapea EmployeeTask al formato ProductionTask que espera TaskCard */
const toProductionTask = (
  task: EmployeeTask,
              ...
              {filteredTasks.map((task) => (
                <TaskCard
                  ...
                  task={toProductionTask(task, {
                    assigned_to: task.assigned_to || undefined,
                    assigned_user_name: task.assigned_user_name || undefined,
                    assigned_user_occupation:
                      task.assigned_user_occupation || undefined
                  })}
                  completable
