              ...
              <Card title="Preferencias de Notificación">
                <div className="space-y-6">
                  <ToggleSetting
                    ...
                    onToggle={() =>
                      setNotif((p) => ({ ...p, stockAlerts: !p.stockAlerts }))
                    }
                  />
                  <ToggleSetting
                    icon={ShoppingBag}
                    ...
                    onToggle={() =>
                      setNotif((p) => ({ ...p, newOrders: !p.newOrders }))
                    }
                  />
                  <ToggleSetting
                    icon={Bell}
                    ...
                    onToggle={() =>
                      setNotif((p) => ({ ...p, appUpdates: !p.appUpdates }))
                    }
                  />
                </div>
              </Card>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                      Los correos salen desde{' '}
                      <strong className="text-gray-700 dark:text-gray-300">
                        {mailStatus?.sender_email || 'la cuenta del sistema'}
                      </strong>{' '}
                      y al responder el cliente te escribe directo a{' '}
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-gray-500 dark:text-gray-400 font-medium mt-0.5">
                          ...
                          · Rol: {user?.role_name?.toUpperCase() || 'N/A'}
                        </p>
                        <p className="text-xs text-gray-400 mt-1">
                          Tokens almacenados en sessionStorage (se eliminan al
                          cerrar el navegador).
                        </p>
                      </div>
                    </div>
