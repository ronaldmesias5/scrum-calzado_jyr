...
> **IMPORTANTE: Este archivo es solo para uso local.**
> **NO lo subas al repositorio.** Esta en `.gitignore` intencionalmente.
> Recibelo por correo y guardalo en tu `docs/` local.
